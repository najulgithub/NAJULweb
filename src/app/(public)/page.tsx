    ...
    <>
      ...
      <section className="relative grano overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(192,102,63,0.18), transparent 65%)",
          }}
        />
        <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-5 pb-20 pt-16 lg:grid-cols-[1.15fr_0.85fr] lg:px-8 lg:pb-28 lg:pt-24">
          <div>
            <p className="subir text-[0.75rem] uppercase tracking-[0.34em] text-clay">
            ...
            >
              La luz de tu casa,
              <br />
              <span className="italic text-clay">bien vestida.</span>
            </h1>
            <p
            ...
            >
              {wa && (
                <a
                  ...
                  className="rounded-full bg-clay px-7 py-3.5 text-sm font-medium text-white shadow-sm transition-colors hover:bg-clay-dark"
                >
                  Pedí tu presupuesto
                </a>
              )}
          ...
          >
            <div className="relative aspect-[4/5] overflow-hidden rounded-[2rem] border border-line bg-paper shadow-xl shadow-black/5">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, rgba(243,236,225,0) 40%, rgba(192,102,63,0.14) 100%)",
                }}
              />
      ...
      <section id="trabajos" className="mx-auto max-w-6xl px-5 py-20 lg:px-8">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <p className="text-[0.72rem] uppercase tracking-[0.3em] text-clay">
              Qué hacemos
            </p>
          ...
          <Link
            href="/recomendador"
            className="text-sm text-ink-soft underline decoration-clay/40 underline-offset-4 hover:text-clay"
          >
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {tipos.map((t, i) => (
            <Link
              ...
              className="group relative overflow-hidden rounded-2xl border border-line bg-paper p-6 transition-all hover:-translate-y-1 hover:border-clay/40 hover:shadow-lg hover:shadow-black/5"
            >
              <span className="font-display text-4xl text-line transition-colors group-hover:text-clay/30">
              ...
              <span className="mt-6 inline-flex items-center gap-1 text-sm text-clay opacity-0 transition-opacity group-hover:opacity-100">
                Ver ejemplos →
              </span>
            </Link>
          ))}
      ...
      <section className="relative overflow-hidden bg-ink text-bone">
        <div className="mx-auto flex max-w-6xl flex-col items-start gap-8 px-5 py-20 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          ...
          <Link
            href="/recomendador"
            className="rounded-full bg-clay px-8 py-4 text-sm font-medium text-white transition-colors hover:bg-clay-dark"
          >
      ...
      <section id="nosotros" className="border-y border-line bg-paper">
        <div className="mx-auto grid max-w-6xl gap-10 px-5 py-20 lg:grid-cols-2 lg:px-8">
          <h2 className="font-display text-4xl font-semibold leading-tight text-ink sm:text-5xl">
            ...
            <span className="italic text-clay">como querés.</span>
          </h2>
      ...
      <section className="mx-auto max-w-6xl px-5 py-24 text-center lg:px-8">
        ...
        {wa && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-8 inline-block rounded-full bg-clay px-8 py-4 text-sm font-medium text-white transition-colors hover:bg-clay-dark"
          >
            Pedí tu presupuesto
          </a>
        )}
